            ...
            module.exports = function (chart) {
                ...
                function plotLine(selection) {
                    selection.each(function (d) {
                        ...
                        innerSelection.enter().append("path").attr("class", "line line-" + index).attr("stroke-width", 1.5).attr("stroke-linecap", "round");
        ...
        11: [function (require, module, exports) {
            ...
            function generateEvaluator(samplerName) {
                ...
                function evaluate(meta, property, variables) {
                    ...
                    return getCompiledExpression(meta, property).evaluate(extend({}, meta.scope || {}, variables))
                }
                return evaluate
            }
